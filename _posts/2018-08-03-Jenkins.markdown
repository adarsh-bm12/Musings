...
6. Images
![My helpful screenshot]({{ "https://github.com/adarshbm82/Musings/blob/master/images/integrate-in-jenkins.png" | absolute_url }})
<br><br>
![My helpful screenshot]({{ "https://github.com/adarshbm82/Musings/blob/master/images/integrate-in-jenkins.png" | absolute_url }})<br><br>
